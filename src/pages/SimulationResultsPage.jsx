...
export default function SimulationResultsPage() {
  ...
  const [activeTab, setActiveTab] = useState('executive'); // executive, personas, charts
      ...
      <header className="bg-white border-b border-border/40 px-6 py-4 flex items-center justify-between sticky top-0 z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">Should we introduce AI tools in Grade 5?</p>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-100">
                <CardContent className="p-6">
                  ...
                  <p className="text-4xl font-bold text-blue-900">62/100</p>
                  <p className="text-sm text-blue-700 mt-2">Cautiously Optimistic</p>
                </CardContent>
              </Card>
              <Card className="bg-gradient-to-br from-red-50 to-rose-50 border-red-100">
                <CardContent className="p-6">
                  ...
                  <p className="text-xl font-bold text-red-900 leading-tight mt-2">"Screen time displacement of core writing skills"</p>
                </CardContent>
              </Card>
              <Card className="bg-gradient-to-br from-emerald-50 to-teal-50 border-emerald-100">
                <CardContent className="p-6">
                  <h3 className="text-sm font-medium text-emerald-800 mb-1">Strongest Supporter</h3>
                  <p className="text-xl font-bold text-emerald-900 leading-tight mt-2">High-performing Students & Progressive Teachers</p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <ul className="space-y-4">
                    <li className="flex gap-3 items-start">
                      ...
                      <p className="text-sm text-muted-foreground"><strong className="text-foreground">Teacher Training Gap:</strong> 40% of simulated teachers felt anxious about their own competence in monitoring AI use, fearing they will look foolish in front of students.</p>
                    </li>
                    <li className="flex gap-3 items-start">
                      <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 shrink-0" />
                      <p className="text-sm text-muted-foreground"><strong className="text-foreground">Equity Concerns:</strong> Budget-conscious parents expressed worry about required home subscriptions or hardware upgrades.</p>
                    </li>
                  </ul>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <ul className="space-y-4">
                    <li className="flex gap-3 items-start">
                      ...
                      <p className="text-sm text-muted-foreground"><strong className="text-foreground">Lead with "Enhancement, not Replacement":</strong> Communication to parents must explicitly state that handwriting and critical thinking remain the core assessment criteria.</p>
                    </li>
                    <li className="flex gap-3 items-start">
                      <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0" />
                      <p className="text-sm text-muted-foreground"><strong className="text-foreground">Pilot First:</strong> Run a 4-week pilot in one subject (e.g., Science) before full deployment to build teacher confidence.</p>
                    </li>
                  </ul>
                </CardContent>
              </Card>
        ...
        {activeTab === 'personas' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-sm text-muted-foreground border border-border px-3 py-1.5 rounded-lg bg-white shadow-sm">Showing 4 of 50 generated personas</div>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className={`px-2.5 py-1 rounded-full text-xs font-medium border ${
                        ...
                        persona.sentiment.includes('Concerned') ? 'bg-red-50 text-red-700 border-red-200' : 
